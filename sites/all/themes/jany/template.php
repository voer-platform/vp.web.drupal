 ...
 */
function jany_views_bulk_operations_form_alter(&$form, &$form_state, $vbo) {
 ...
 */
function jany_preprocess_maintenance_page(&$vars) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // jany_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  jany_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function jany_preprocess_html(&$vars) {
 ...
 */
function jany_preprocess_page(&$vars) {
 ...
 */
function jany_admin_block_content($variables) {
...
function jany_breadcrumb($variables) {
  $sep = ' <span></span> ';
 ...
 * @see overlay.tpl.php
 */
function jany_preprocess_overlay(&$variables) {
