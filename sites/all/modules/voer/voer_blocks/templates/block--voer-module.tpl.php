<div class="span4">
  <div class="vertical-shadow suggested-action">
    <div class="suggested-action-image-link cls_module" style="background-image: url('<?php echo drupal_get_path('module', 'voer_blocks') ?>/images/default_image.jpg');"><a href="/module/<?php print $material_id ?>">&nbsp;</a></div>
