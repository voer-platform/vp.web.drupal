<div class="row-fluid suggested-actions">
  ...
  <div class="span4">
    <a href="detail-module.html" class="vertical-shadow suggested-action">
      <div class="suggested-action-image-link cls_module"></div>
      <h2 class="pulls ellipsis suggested-action-title">Chi phí kinh doanh trong doanh nghiệp thương mại</h2>
      <h5>Economic & Finance (534)</h5>
      <p class="pulled">Software Engineering (SE) has been defined as the application of sound engineering principles.</p>
      <span class="caption">Module (11.323)</span>
    </a>
  </div>
  ...
  <div class="span4">
    <a href="#" class="vertical-shadow suggested-action">
      ...
      <p class="pulled">Presents fundamental concepts and tools in signal processing: linear and shift-invariant systems.</p>
  ...
  <div class="span4">
    <a href="detail-course.html" class="vertical-shadow suggested-action">
      ...
      <h2 class="pulls ellipsis suggested-action-title">Designing and Executing Information Security Strategies</h2>
      <h5>Computer Science (27)</h5>
      <p class="pulled">Software Engineering (SE) has been defined as the application of sound engineering principle.</p>
